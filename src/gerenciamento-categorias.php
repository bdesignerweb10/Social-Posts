			    ...
			    <table class="table tbl-default table-hover">
				  ...
				  <tbody>
				    ...
				    <tr>
				      ...
				      <td>
				      	<a href="#" class="btn-edit-categoria" data-id="<?php echo $id;?>" title="Editar informações da categoria <?php echo $cat->id_categoria; ?>"><i class="fas fa-edit icon-edit"></i></a>				      	
				      	<a href="#" class="btn-del-categoria" data-id="<?php echo $id;?>" title="Deletar categoria <?php echo $cat->id_categoria; ?>" ><i class="fas fa-trash-alt icon-delete"></i></a>
				      </td>
				    </tr>
				    <?php } ?>			        	
			        	<?php } else { ?>
		...
		<div class="row">
			<div class="col-sm-12 space">
				<div class="card">
					...
					<div class="card-body">
					    <form id="form-gerenciamento-categorias" action="acts/acts.acts.categoria.php" method="post">
							<div class="form-row">	
								<div class="col-md-1">		    			
							    ...
							    <div class="form-group col-md-6">
							      ...
							      <input type="text" class="form-control" id="title-cat" name="title-cat"  placeholder="Informe o título da categoria">
							    </div>	    
							    ...
							    <div class="form-group col-md-12">
								  <label for="description-cat">Descrição da categoria</label>
							...
							<div class="row btn-action-2">
								<div class="col-sm-8"></div>
								  	<div class="col-sm-4">
								  		<button type="submit" class="btn btn-lg btn-primary btn-default" id="btn-salvar-categoria"><i class="far fa-save"></i> Salvar Categoria</button>
								  	</div>					  	
							  	</div>
							</div>
						</form>

		...
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav mr-auto">
		      ...
		      <li class="nav-item">
		        <a class="nav-link" href="quem-somos.php">Sobre a Social Posts</a>
		      </li>
		      <li class="nav-item">
		    ...
		    <ul class="navbar-nav mr-auto nav-users">
		    	<li class="nav-item">
		        	<a class="nav-link nav-login" href="login.php">Entrar</a>
		      	</li>
		    	<li class="nav-item">
		        	<a class="nav-link nav-register" href="#">Cadastrar</a>
		      	</li>		        
		    </ul>
		  </div>
		</nav>
